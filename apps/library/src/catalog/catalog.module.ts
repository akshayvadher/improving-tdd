...
const FILE_STORAGE_GATEWAY = Symbol('FileStorageGateway');
...
@Module({
  ...
  providers: [
    ...
    },
    {
      ...
      useFactory: (): FileStorageGateway => new InMemoryFileStorageGateway(),
    },
    {
      ...
      ) => new CatalogFacade(repository, randomUUID, gateway, cache, accessControl, fileStorage),
      inject: [
        CATALOG_REPOSITORY,
        ISBN_LOOKUP_GATEWAY,
        BOOK_CACHE_GATEWAY,
